...
{
    /// <summary>
    /// 提供 <see cref="float"/>对象的序列化和反序列化操作
    /// </summary>
    [Export(typeof(IFormatter))]
    [ExportMetadata("BindType", typeof(Single))]
    [ExportMetadata("HeadFlag", HeadFlag.Single)]
    public sealed class SingleFormatter :FormatterBase
    {
